...
ax.set_title(f"Composition: induction heads break when their upstream signal is cut\n{MODEL}", fontweight="bold")
ax.legend()
...
ax.set_title(f"Upstream cut: ablating prev-token heads also hurts in-context learning\n{MODEL}", fontweight="bold")
